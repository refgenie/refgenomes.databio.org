...
for stat in all_relevant_stats:
    ...
    print(f"here is how many {stat} were equal to 1.0 divided by all comparisons")
    print((count_target/count_all)*100)

    print(f"here is how many samples were equal to 1.0 divided by all total number of samples for stat {stat}")
